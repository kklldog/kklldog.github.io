...
| SSO:OIDC:tokenEndpointAuthMethod | 获取 token 接口的认证方案，目前支持：client_secret_post, client_secret_basic, none 三种方案，默认为：接口的认证方案，目前支持：client_secret_post  | client_secret_post |
